...
class TurnGeneratorTab : public IScreen
{
  ...
  private:
    ...
    {
      "Turn Length", "Turn Diameter", "Rough Step", "Rough Speed", "Finish Step", "Finish Speed", "Generate"
    };
    ...
    // Strings
    char str[TURN_MAX_ITEMS][32u + 1u] = {0};
    // menu items
    Menu::MenuItem menu_items[TURN_MAX_ITEMS];
    // Menu object
    Menu menu;
...
class FaceGeneratorTab : public IScreen
{
  ...
  private:
    ...
    {
      "Face Length", "Face Diameter", "Rough Step", "Rough Speed", "Finish Step", "Finish Speed", "Generate"
    };
    ...
    // Strings
    char str[FACE_MAX_ITEMS][32u + 1u] = {0};
    // menu items
    Menu::MenuItem menu_items[FACE_MAX_ITEMS];
    // Menu object
    Menu menu;
...
class CutGeneratorTab : public IScreen
{
  ...
  private:
    ...
    const char* const menu_strings[FACE_MAX_ITEMS] =
    {
      "Cut Diameter", "Cut Width", "Cut Step", "Cut Speed", "Generate"
    };
